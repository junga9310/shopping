...
public class ProdDetail implements Action {
	...
	public void execute(HttpServletRequest request, HttpServletResponse respons) throws ServletException, IOException {
		...
		if(id == null) {
			...
			request.setAttribute("redirectPath", "page/product/prodInupt.jsp"); //�엯�젰 �뤌�쑝濡� 媛�寃� �븷 嫄곗엫. �븘吏� 
		...
		try {
			...
			if(list == null) {
				...
				url= "page/product/product-details.jsp";
			}
		}catch(Exception e){
			e.printStackTrace();
		}
