...
<!-- "page/product/prodlist.jsp" -->
<!--wm?command=prodinsert  -->
<button type="button" onclick="location.href='${pageContext.request.contextPath}/page/product/productInput.jsp'">입력하기</button><br>
